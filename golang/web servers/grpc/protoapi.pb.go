...
func (*UnimplementedRandomServer) GetDate(ctx context.Context, req *RequestDateTime) (*DateTime, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetDate not implemented")
}
func (*UnimplementedRandomServer) GetRandom(ctx context.Context, req *RandomParams) (*RandomInt, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetRandom not implemented")
}
func (*UnimplementedRandomServer) GetRandomPass(ctx context.Context, req *RequestPass) (*RandomPass, error) {
