...
// The time.Now().Unix() function returns the popular UNIX epoch time, which is the number
// of seconds that have elapsed since 00:00:00 UTC, January 1, 1970. If you want to convert
// the UNIX time to the equivalent time.
